const BANK_NODE_LENDING_REWARDS = [
  {
    anonymous: false,
    inputs: [
      {
  ...
  {
    inputs: [
      { internalType: "uint256", name: "stakingVaultKey", type: "uint256" },
    ],
  ...
  {
    inputs: [{ internalType: "uint256", name: "vaultValue", type: "uint256" }],
    name: "decodeVaultValue",
    outputs: [
      { internalType: "uint256", name: "amount", type: "uint256" },
      { internalType: "uint40", name: "depositTime", type: "uint40" },
    ],
    stateMutability: "pure",
    type: "function",
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address", name: "_bankNodeManager", type: "address" },
      { internalType: "address", name: "distributorAdmin", type: "address" },
      { internalType: "address", name: "managerAdmin", type: "address" },
    ],
    name: "initialize",
    outputs: [],
    stateMutability: "nonpayable",
...
export default BANK_NODE_LENDING_REWARDS;
